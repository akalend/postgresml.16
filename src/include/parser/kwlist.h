...
PG_KEYWORD("eval", EVAL, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("ignored", IGNORED, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("loss", LOSS, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("output", OUTPUT, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("predict", PREDICT, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("ranking", RANKING, UNRESERVED_KEYWORD, BARE_LABEL)
