...
PG_CMDTAG(CMDTAG_DROP_MODEL, "DROP MODEL", true, false, false)
...
PG_CMDTAG(CMDTAG_LOAD_MODEL, "LOAD MODEL", false, false, false)
...
PG_CMDTAG(CMDTAG_PREDICT_MODEL, "PRDICT MODEL", true, false, false)
...
PG_CMDTAG(CMDTAG_SHOW_MODEL, "SHOW MODEL", false, false, false)
